...
const RULE_ID = 'no-unknown-css-part';

const rule: Rule.RuleModule = {
  meta: {
    type: 'problem',
    docs: {
      description: 'Disallow ::part() selectors not defined in the Custom Elements Manifest'
    },
    schema: webqOptionSchema,
    messages: {
      unknownCssPart: '{{webqMessage}}'
    }
  },
