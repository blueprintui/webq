...
const RULE_ID = 'no-unknown-attr-value';

const rule: Rule.RuleModule = {
  meta: {
    type: 'problem',
    docs: {
      description: 'Disallow attribute values not matching the types defined in the Custom Elements Manifest'
    },
    schema: webqOptionSchema,
    messages: {
      invalidValue: '{{webqMessage}}'
    }
  },
