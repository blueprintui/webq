...
const RULE_ID = 'no-missing-required-child';

const rule: Rule.RuleModule = {
  meta: {
    type: 'problem',
    docs: {
      description: 'Disallow missing required child elements defined in Custom Elements Patterns'
    },
    schema: webqOptionSchema,
    messages: {
      missingRequiredChild: '{{webqMessage}}'
    }
  },
    ...
    function checkDocument() {
      ...
      for (const msg of messages) {
        ...
        context.report({
          ...
          messageId: 'missingRequiredChild',
