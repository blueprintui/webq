...
const RULE_ID = 'no-deprecated-attr';

const rule: Rule.RuleModule = {
  meta: {
    type: 'suggestion',
    docs: {
      description: 'Warn when using a deprecated attribute on a custom element'
    },
    schema: webqOptionSchema,
    messages: {
      deprecatedAttr: '{{webqMessage}}'
    }
  },
